const HomeP6 = () => {
  return (
    <div>
      <h3>Customise & Optimise Your Grading</h3>
      <p>
        ...
        advanced partial credit logic or prohibit use of certain keywords while
        ...
        number of answers, which is then fed into the AI engine for training to
        produce predictions for the remaining answers. Next, you review these
        predictions and revise them if necessary before publishing the results.
        If you like, you can also include additional feedback on a case-by-case
        basis. Our AI engine reduces time required for marking of essay-type
        questions from days to hours. <br></br>
        <br></br>SageGrader is simple, easy to understand (both for instructors
        and students), and most importantly, 100% transparent in the
        auto-generated feedbacks to minimise student complaints as the students
        will be able to see justification for any points lost together with
        feedback on how to improve their performance. <br></br>
        <br></br>If needed, the instructor can add multiple graders for the same
        assessment by delegating tasks such as revising marking criteria, adding
        unit tests, or adding general & custom feedback. However, only an
        instructor role can create a new assessment. <br></br>
        <br></br>In SageGrader, auto-marking can be run in batches. This way,
        you can auto-mark student submissions in different batches at different
        times.<br></br>
        <br></br> During the auto-marking process, you can revise the marking
        criteria and the unit tests and then perform auto-marking once again for
        as many times as you like until you are happy with the results! For
        instance, you can increase your partial credits or set minimum partial
        credits for certain questions if the class average turns out to be a bit
        lower than desired. <br></br>
        ...
        <em>
          ...
          <br></br>-"Federation University is not in Melbourne, though it is in
          Victoria. Partial credit was awarded for this answer."<br></br>
          <br></br>- "Population variance reported instead of sample variance;
          3.0 points awarded."<br></br>
          <br></br> - "Equation solved correctly, however, the incorrect root of
          -10 is reported as the final answer; 2.5 points awarded." <br></br>
          ...
          <br></br>- "This answer of 21.8 units for the perimeter is incorrect.
          However, it is a correct follow-through of your previous incorrect
          answer of 5.4 units for the square's side length. For this reason, you
          have been awarded a partial credit of 2.5 points."
        </em>
      </p>
      <img

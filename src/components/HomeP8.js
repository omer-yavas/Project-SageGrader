    ...
    <div>
      ...
      <p>
        <em>
          ...
          many hours of repetitive marking, but also given me an intuitive means
          to provide informative feedback to students. <br></br>
          ...
          single paper multiple times. SageGrader removes most opportunities for
          human error and completely eliminates marking bias by applying a
          ...
          grade. I am able to confidently mark the entire cohort of quizzes and
          provide next day results and feedback due to SageGrader removing all
          the repetitive motions of marking. The informative insights and
          compilation of unique answers allow me to have a one and done
          examination of each question. This means I have more time on polishing
          the quiz feedback to ensure it holistically covers all relevant
          content. The results returned to students are not only transparent but
          also informative, and alongside the appropriate feedback, tend to
          minimise mark disputes."
        </em>
      </p>
      <h3>Anders Yeo</h3>
      <div>Teaching assistant, Introduction to Analytics, RMIT University</div>
    </div>
  );
};

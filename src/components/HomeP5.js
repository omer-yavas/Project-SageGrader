...
const HomeP5 = () => {
  return (
    <div className={classes.p5box}>
      ...
      <div>
        <h3>Insights Report for instructors</h3>
        <p>
          At the completion of auto-marking, SageGrader provides you the
          following:
        </p>
        <ul>
          <li>An Insights Report on students' overall performance</li>
          <li>
            All the unique student answers for each question with their
            frequencies & points you awarded
          </li>
          <li>
            A comprehensive similarity report for any suspected cheating
            incidents
          </li>
        </ul>
      </div>
